...
import './Shuffle.css'; // Added import for Shuffle.css
...
const Shuffle = ({
  ...
  threshold = 0.1,
  rootMargin = '-100px',
  tag = 'h1', // Changed default tag to h1 for semantic correctness if used as a title
  textAlign = 'center',
  onShuffleComplete,
  shuffleTimes = 1,
  ...
  const Tag = tag; // Use the tag prop
