// frontend/src/components/Hyperspeed.js
      ...
      constructor(container, options = {}) {
        ...
        if (this.options.distortion == null) {
          this.options.distortion = {
            uniforms: {},
            getDistortion: `vec3 getDistortion(float progress){ return vec3(0.); }`
          };
        }
          ...
          fragmentShader: isRoad ? `
            ...
            void main() {
              ...
              for (float i = 1.0; i < uLanes; i += 1.0) {
                  float brokenLines = step(laneWidth * i - brokenLineWidth, uv.x) * step(uv.x, laneWidth * i);
